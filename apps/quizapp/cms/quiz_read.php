...
<p>
<a href="quiz_read.php?myOrder=question_statement"><button>Order by statements Alphabetical a-z</button></a>
	<a href="quiz_read.php?myOrder=question_statement DESC"><button>Order by statements Alphabetical z-a</button></a>
</p>
...
<p>
<a href="quiz_read.php?myOrder=question_id"><button>Order by question id, low to high</button></a>
	<a href="quiz_read.php?myOrder=question_id DESC"><button>Order by question id, high to low</button></a>
</p>
